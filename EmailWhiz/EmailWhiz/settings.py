"""
Django settings for EmailWhiz project.
...
# EmailWhiz/EmailWhiz/settings.py
import os
...
SECRET_KEY = 'django-insecure-o&57a$#8r(l+el$t+v6hl72+jz97x1_4h&81(pvy7gr7s$ik-h'
...
WSGI_APPLICATION = 'EmailWhiz.wsgi.application'
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'emailwhiz_ui', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',
