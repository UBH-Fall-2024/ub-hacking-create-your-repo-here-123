...
class CustomUserCreationForm(UserCreationForm):
    ...
    class Meta:
        model = CustomUser
        fields = ['username', 'first_name', 'last_name', 'phone_number', 'linkedin_url', 'email', 'graduated_or_not', 'college', 'password1', 'password2', 'gmail_id', 'gmail_in_app_password', 'gemini_api_key']
